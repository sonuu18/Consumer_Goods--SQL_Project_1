-- 1. Provide the list of markets in which customer "DeTech Exclusive" operates its business in the APAC region

SELECT Distinct(market)
FROM dim_customer
WHERE customer = 'DeTech Exclusive' AND region = 'APAC';
...
-- 7. Get the complete report of the Gross sales amount for the customer “DeTech Exclusive” for each month. This analysis helps to get an idea of low and high-performing months and take strategic decisions. The final report contains these columns: Month Year Gross sales Amount
...
WHERE c.customer = "DeTech Exclusive"
